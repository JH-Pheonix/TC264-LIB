...
*                  ------------------------------------
*                  模块管脚             单片机管脚
*                  TXD                查看 zf_device_mt9v03x.h 中 MT9V03X_COF_IIC_SCL 宏定义
*                  RXD                查看 zf_device_mt9v03x.h 中 MT9V03X_COF_IIC_SDA 宏定义
...
#define MT9V03X_COF_IIC_SCL     (P33_13)                                        // 总钻风 IIC-SCL 引脚
#define MT9V03X_COF_IIC_SDA     (P32_4)                                         // 总钻风 IIC-SDA 引脚

#define MT9V03X_DMA_CH          (IfxDma_ChannelId_7)

#define MT9V03X_PCLK_PIN        (ERU_CH1_REQ10_P14_3)                           // PCLK 触发信号 TIM_ETR 引脚禁止随意修改

#define MT9V03X_VSYNC_PIN       (ERU_CH4_REQ8_P33_7)                            // 场中断引脚
