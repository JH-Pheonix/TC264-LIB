...
//=================================================定义 TSL1401 基本配置================================================
#define TSL1401_AO_PIN (ADC0_CH0_A0)  // 对应第一个 TSL1401 的 AO 引脚
#define TSL1401_AO_PIN1 (ADC0_CH5_A5) // 对应第二个 TSL1401 的 AO 引脚
// TSL1401 的控制引脚定义 多个 TSL1401 建议将控制引脚直接并联
#define TSL1401_CLK_PIN (P33_7) // TSL1401 的 CLK 引脚定义
#define TSL1401_SI_PIN (P33_6)  // TSL1401 的 SI 引脚定义
...
void tsl1401_init(uint8 index);                              // TSL1401 线阵 CCD 初始化
//=================================================声明 TSL1401 基础函数=================================================
